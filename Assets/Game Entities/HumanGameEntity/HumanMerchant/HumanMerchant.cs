...
public class HumanMerchant : HumanGameEntity
{
    StateMachine<HumanMerchant> stateMachine;
    ...
    */
    ...
    public HumanMerchant(int id) : base(id)
    {
    }
    ...
    public void Awake()
    {
        ...
        stateMachine = new StateMachine<HumanMerchant>(this)
        {
            CurrentState = HumanMerchantRest.Instance
        };
    }
    ...
    public override void Respawn()
    {
        ...
        health = 100;
        stamina = 100;
        stateMachine.ChangeState(HumanMerchantRest.Instance);
    }
    ...
    public override void Update()
    {
        ...
        if (stateMachine.CurrentState == HumanMerchantRest.Instance && !cSteerPoint.enabled)
        ...
        {
            if (stateMachine.CurrentState != HumanMerchantRest.Instance && biped.Speed >= 0.1f)
    ...
    public StateMachine<HumanMerchant> GetFSM()
    {
        return stateMachine;
    }
